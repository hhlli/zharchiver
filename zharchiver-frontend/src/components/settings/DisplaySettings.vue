      ...
      <div class="p-4 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
        ...
        <div class="flex bg-gray-100 p-1 rounded-lg">
          <button 
            ...
            :class="['px-4 py-1.5 rounded-md transition-all cursor-pointer text-xs font-medium flex items-center space-x-1.5', viewMode === 'grid' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-900']"
          >
          ...
          <button 
            ...
            :class="['px-4 py-1.5 rounded-md transition-all cursor-pointer text-xs font-medium flex items-center space-x-1.5', viewMode === 'list' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-900']"
          >
